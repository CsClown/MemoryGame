...
def pick_cards(player):
    ...
    while True:
        if player.name == 'Computer':
            ...
            time.sleep(0.2)
            print(
                f'The Computers first pick is: '
                f'{player.pick1[0]}{player.pick1[1]}'
            )
            time.sleep(2)
            ...
            time.sleep(0.2)
            print(
                f'The Computers second pick is: '
                f'{player.pick2[0]}{player.pick2[1]}'
            )
            time.sleep(1)
...
def end_of_game():
    """
    Checks if all pairs are found and displays winner (or draw)
    and final scores. returns Boolean
    """
    if player1.score + player2.score == 8:
        clear_terminal()
        print('\n+++ Game over +++\n')
        if player1.score > player2.score:
            print(
                f"Congratulations, {player1.name}! \n"
                f"You won with {player1.score} points\n"
            )
            print(f"Your pairs: ")
            ...
            print(
                f'The Computer has beaten you with '
                f'{player2.score} to {player1.score} points\n'
            )
...
def name_input():
    ...
    while True:
        ...
        if not username:
            ...
            print(
                'Name has to start with alphabetic characters\n'
